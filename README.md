...
This simple script is short for test purposes, no one would need this cycle, but such things could get useful over hours if you are only interested in night temperatures for instance.
